...
int main() {
    ...
    MasinaElectrica me("Tesla", "Model 3", 1.2, "Rosu", "Da", 'B', 2017, 214000, 20000, 5.2, "Disponibil", 50, 'N' );
    ...
    m3.AplicaDiscount();         //Masina dupa 2005..

    m1.AplicaDiscount();
    m1.AplicaDiscount();         //Am verificat daca discount-ul e aplicat doar o singura data
    ...
    me.AplicaDiscount();        //Masina Fara FC..
    me.AplicaDiscount();        //Discount deja aplicat..
